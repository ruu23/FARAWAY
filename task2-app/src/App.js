  ...
  return (
    <div className="App">
      ...
      <ul>
        ...
        <div><select className='btn-list' value={sortOrder} onClick={sortItems} onChange={(e) => setSortOrder(e.target.value)}>
          <option value="inputOrder">Sort by Input Order</option>
          <option value="description">Sort by Description</option>
          <option value="packedStatus">Sort by Packed Status</option>
        </select>
        <button className='btn-list' onClick={clearList}>CLEAR LIST</button></div>
